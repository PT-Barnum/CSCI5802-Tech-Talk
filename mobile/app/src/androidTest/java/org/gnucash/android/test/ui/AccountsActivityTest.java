...
//        onView(withId(R.id.context_menu_edit_accounts)).check(matches(isDisplayed())).perform(click());
    ...
    /**
     * Tests that an account can be added successfully
     */
    @Test
    public void testAddAccount2(){
        ...
        refreshAccountsList();
        onView(allOf(isDisplayed(), withId(R.id.fab_create_account))).perform(click());
        String addAccount2 = "Newly Added Account #2";
        String descriptionForAccount2 = "Description for Account #2";

        // Exercise
        onView(withId(R.id.input_account_name)).perform(typeText(addAccount2));
        onView(withId(R.id.input_account_description)).perform(typeText(descriptionForAccount2));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.menu_save)).perform(click());

        // Verify
//        onView(withId(R.id.primary_text)).check(matches(withText(addAccount2)));
        List<Account> accounts = mAccountsDbAdapter.getAllRecords();
        assertThat(accounts).hasSize(2);
        Account newlyCreatedAccount = accounts.get(0);
        assertThat(newlyCreatedAccount.getName()).isEqualTo(addAccount2);
        assertThat(newlyCreatedAccount.getDescription()).isEqualTo(descriptionForAccount2);
    }

    /**
     * Tests that an account can successfully be modified
     */
    @Test
    public void testEditAccount1(){
        // Exercise
        onView(withId(R.id.options_menu)).perform(click());
        onView(withText("Edit Account")).perform(click());
        String description = "Description for account";
        onView(withId(R.id.input_account_description)).perform(typeText(description));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.menu_save)).perform(click());
        ...
        onView(withId(R.id.options_menu)).perform(click());
        onView(withText("Edit Account")).perform(click());
        onView(withId(R.id.input_account_description)).check(matches(withText(description)));
    }
    ...
    public void testEditAccount2(){
        ...
        onView(withId(R.id.options_menu)).perform(click());
        onView(withText("Edit Account")).perform(click());
        String addAccount = "Edited Account Name";
        onView(withId(R.id.input_account_name)).perform(clearText());
        onView(withId(R.id.input_account_name)).perform(typeText(addAccount));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.menu_save)).perform(click());
        ...
        Account newlyEditedAccount = accounts.get(0);
        assertThat(newlyEditedAccount.getName()).isEqualTo(addAccount);
    }

    /**
     * Tests that an account can be successfully deleted
     */
    @Test
    public void testAccountDelete1(){
        // Exercise
        onView(withId(R.id.options_menu)).perform(click());
     ...
     */
    @Test
    public void testAccountDelete2(){
        // Exercise
        onView(withId(R.id.options_menu)).perform(click());
        onView(withText("Delete")).perform(click());
        onView(withId(R.id.fab_create_account)).perform(click());
        String accountName2 = "Newly Added Account #2";
        onView(withId(R.id.input_account_name)).perform(typeText(accountName2));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.menu_save)).perform(click());
        onView(withId(R.id.primary_text)).check(matches(withText(accountName2)));
        onView(withId(R.id.options_menu)).perform(click());
        onView(withText("Delete")).perform(click());
